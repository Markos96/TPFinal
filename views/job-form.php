    ...
    <div class="row row__pr ">
        <div class="col-12">
            <div class="d-flex flex-column align-items-center rounded" style="background-color: #DDDDDD;">
                <h3 class="card-title text-center fs-6 my-3 fw-bolder"><?php echo (($jobs->getId() == null) ? "Agregar" : "Modificando" ) . " oferta laboral"?></h3>
                <div class="align-self-center card-body mb-3 card-body__pr">
                    <form action="<?php echo FRONT_ROOT ?>job/add" method="POST">
                        ...
                        <textarea class="mb-3 form-control" name="description" style="resize: none;font-size: .8rem; height: 200px" placeholder="Agregue una descripcion"><?php echo (isset($jobs) ? $jobs->getDescription() : "") ?></textarea>
                        <select name="enterprise" id="" class="form-select mb-3">
                            ...
                            <?php foreach ($jobs->getEnterprise() as $enterprise) { ?>
                                <option value="<?php echo $enterprise->getId() ?>"><?php echo $enterprise->getName() ?></option>
                            <?php } ?>
                        </select>
                        ...
                        <select name="career" id="" class="form-select mb-3">
                            ...
                            <?php foreach ($jobs->getCareer() as $career) { ?>
                                <option value="<?php echo $career->getId() ?>"><?php echo $career->getName() ?></option>
                            <?php } ?>
                        </select>
