      ...
      <div class="d-flex flex-column align-items-center rounded" style="background-color: #DDDDDD;">
        ...
        <div class="align-self-center card-body mb-3 card-body__pr">
          <form action="<?php echo FRONT_ROOT ?>enterprise/add" method="POST">
            <input class="mb-3 form-control" type="hidden" name="id" value="<?php echo (isset($this->eId) ? $this->eId : "") ?>">
            <input class="mb-3 form-control" type="text" name="firstName" value="<?php echo (isset($this->eName) ? $this->eName : "") ?>" id="" placeholder="Nombre empresa">
            <textarea class="mb-3 form-control" name="description" style="resize: none;font-size: .8rem; height: 200px"><?php echo (isset($this->eDescription) ? $this->eDescription : "") ?></textarea>
            <div>
